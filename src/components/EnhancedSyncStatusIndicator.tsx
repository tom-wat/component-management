  ...
  return (
    <div className={`flex items-center space-x-2 ${className}`}>
      ...
      {(status === 'error' || !isOnline) && onRetry && (
        <button
          onClick={onRetry}
          className="text-xs px-2 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
          title="再試行"
        >
          再試行
        </button>
